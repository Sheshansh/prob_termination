...
Previous work testifies that analogous ``bounded 
expected change'' constraints naturally emerge when one aims to obtain 
additional information about runtime of programs 
~\cite{HolgerPOPL,CFNH16:prob-termination,CNZ17,CF17}. The major novelty of our 
bounded ECI condition is that it can be used to obtain polynomial bounds on 
expected runtime using \emph{linear} supermartingales.
