...
(for which there is a good automated tool support~\cite{xxx}) that 
overapproximate set of reachable configurations and encoding the rankingn, 
unaffection, and non-negativity conditions into a collection of linear 
constraints (as for general LinLexRSMs in Section~\ref{xxx}). 
